...
//			trafficMetrics.print();
	...
	private void createPredicatesDomains() {
		...
		leftPredTaxonomy.addTerm(">");
		leftPredTaxonomy.addTerm("-");
		leftPredTaxonomy.addTerm("w"); /*	-> JAVI para MASSIMO: Anyado el termino "w" (wall)
		como termino posible a la izquierda de un coche */
		
		leftPredTaxonomy.addRelationship("<", "*");
		leftPredTaxonomy.addRelationship(">", "*");
		leftPredTaxonomy.addRelationship("-", "*");
		leftPredTaxonomy.addRelationship("w", "*"); // JAVI: Anyado relacion entre el termino "w" y el mas general (*)
